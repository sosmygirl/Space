							...
							<div class="widget-content">
								<div class="padd">
									<div class="form quick-post">
										...
										<form class="form-horizontal" method="post" action="<%=request.getContextPath()%>/space/buildingspace?buildingid=${buildingid}&currentpage=1&pagesize=3" >
											<!-- Title -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">
									<c:forEach items="${spaces}" var="space" begin="1" end="1">
										${space.name}
									</c:forEach>
								</div>
								<div class="clearfix"></div>
							...
							<div class="widget-content">
								<div class="padd statement">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="well">
												<a href="#" style="display: block; padding: 10px 15px;">
													<h2>场地名称:${space.name}</h2>
													<h3>介绍:${space.describe}</h3>
													<h4>容量:${space.vol}</h4>
												</a>
											</div>
										</div>
								...
								<div class="widget-foot">
									...
									<ul class="pagination pull-right">
										...
										<li>
											<a href="<%=request.getContextPath()%>/space/buildingspace?buildingid=${buildingid}&currentpage=1&pagesize=3" class="btn btn-active alink" >首页</a>
										</li>
										<c:if test="${page.hasPreviousPage}">
											<li>
												<a href="<%=request.getContextPath()%>/space/buildingspace?buildingid=${buildingid}&currentpage=${page.prePage}&pagesize=3" class="btn btn-active alink" >上一页</a>
											</li>
										</c:if>
										<c:forEach items="${page.navigatepageNums}" var="i" >
											<li>
												<a href="<%=request.getContextPath()%>/space/buildingspace?buildingid=${buildingid}&currentpage=${i}&pagesize=3" class="btn btn-active alink" >${i}</a>
											</li>
										</c:forEach>

										<c:if test="${page.hasNextPage}">
											<li>
												<a href="<%=request.getContextPath()%>/space/buildingspace?buildingid=${buildingid}&currentpage=${page.nextPage}&pagesize=3" class="btn btn-active alink" >下一页</a>
											</li>
										</c:if>
										<li>
											<a href="<%=request.getContextPath()%>/space/buildingspace?buildingid=${buildingid}&currentpage=${page.pages}&pagesize=3" class="btn btn-active alink" >尾页</a>
										</li>
